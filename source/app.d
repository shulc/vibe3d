...
void main(string[] args) {
    ...
    void captureStepTrace(string line, uint flags) {
        ...
        //
        // Ordering (confirmed by reading CommandExecutor.applyOrRefire's
        // post-mode-finalize guard, and empirically via /api/tool/state after
    ...
    while (running) {
        ...
        // No-op in the default build.
        {
            ...
            if (httpServer.running) {
                ...
                // and quit ordering, then exclude request-timed bridge work by
                // retaking only the GC baseline. The bracket is pinned by
                // tests/unit/frame_probe_window_wiring_test.d.
                g_fc.rebaseAllocationWindow();
            }
