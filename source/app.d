...
void main(string[] args) {
    ...
    // nested renderVariantPopup). All six CTX-panel entry points take
    // `EditorApp app` and are called `xxxPanel(app)` below;
    // renderViewportSceneToFbo (Phase 6) is the last piece, still below.
