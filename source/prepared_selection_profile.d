...
public:
    ...
    bool takeUnbegun(RadialSweepTool expected,
                     ref RadialSweepProfileImage destination) nothrow @nogc {
        if (begun_ || consumed_ || target_ is null || target_ !is expected ||
            !image_.filled) return false;
        destination = image_;
