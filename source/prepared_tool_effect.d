...
@PreparedAggregate struct PreparedEdgeExtendParamEffect {
    OwnedId owner;
    PreparedEdgeExtendParamKind kind;
    bool accepted;
}
...
@PreparedAggregate struct PreparedArrayParamEffect {
    OwnedId owner;
    PreparedArrayParamKind kind;
    bool accepted;
}
...
@PreparedAggregate struct PreparedReductionParamEffect {
    OwnedId owner;
    PreparedReductionParamKind kind;
    bool accepted;
}
@PreparedAggregate struct PreparedVertexMergeParamEffect {
    OwnedId owner;
    PreparedVertexMergeParamKind kind;
    bool accepted;
}
...
@PreparedAggregate struct PreparedPolyExtrudeParamEffect {
    OwnedId owner;
    PreparedPolyExtrudeParamKind kind;
    bool accepted;
}
@PreparedAggregate struct PreparedPolyInsetParamEffect {
    OwnedId owner;
    PreparedPolyInsetParamKind kind;
    bool accepted;
}
