...
unittest { // dragging the extrude arrow moves `shift` off zero
    ...
    assert(len > 1e-6, "the extrude axis projects to a point");
    ...
    assert(abs(after) > 1e-3,
        "dragging the extrude arrow should have moved shift off zero — this "
