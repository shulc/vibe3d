...
unittest { // Rotate ring: syncGeometry() is a pure function of the current viewport
    ...
    Viewport vpA = v.viewportWith(Vec3(0, 0, 0), 3.0f, Orientation.fromAngles(0.0f, 0.3f, v.roll));
    Viewport vpB = v.viewportWith(Vec3(0, 0, 0), 3.0f, Orientation.fromAngles(PI / 2.0f, 0.3f, v.roll));
