...
unittest
{
    ...
    foreach (config; ["modeling", "web"])
    {
        ...
        // The browser now owns one cancellable remesh Worker; its scope(exit)
        // terminates that worker if the main loop unwinds.
        const expectedFinally = config == "modeling" ? 28 : 1;
