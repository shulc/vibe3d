...
/// `grep -c 'with (app)'` reads 4 and 18 for the two files. The scanner finds
/// one and three live blocks respectively; the remainder are comments/doc lines. The
...
/// 7 before task 6509 removed the mesh-family block and made it 6; task 6670
/// removed the edit-family block and made it 4.
...
unittest {
    ...
    if (ledgerHits.length != 4)
        problems ~= format("\n    with(app) population — recorded 4, scanner "
