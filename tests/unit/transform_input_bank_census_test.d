...
unittest // migrated input banks contain no edit/history lifecycle branch
{
    ...
    assert(migratedBanks.length == 1,
        "transform input-bank census: expected 1 migrated bank after T slice");
    size_t scanned;
    ...
    assert(scanned == 1,
        "transform input-bank census: T population was not traversed");
}
