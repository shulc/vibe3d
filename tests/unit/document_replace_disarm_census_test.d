...
private immutable string[] kCodeIdents = [
    ...
    "commandCommitsToolEditBeforeApply",
];
...
private immutable LedgerRow[] kCodeSites = [
    ...
    LedgerRow("(module scope)|commitsActiveToolEditBeforeApply", 1,
        "the sole definition of the pre-apply commit policy"),
    ...
    LedgerRow("wireHttpProviders.setToolDisarmProvider|g_disarmCrossings", 2,
        "the /api/tool/disarm adapter import and read"),
    LedgerRow("Registry.cacheSupportedModes|dropsActiveToolBeforeApply", 2,
        "the registry-cache import and evaluation"),
    LedgerRow("Registry.cacheSupportedModes|commitsActiveToolEditBeforeApply", 2,
        "the registry-cache import and evaluation"),
    ...
    LedgerRow("Registry|commandCommitsToolEditBeforeApply", 1, "cache declaration"),
    LedgerRow("Registry.cacheSupportedModes|commandCommitsToolEditBeforeApply", 1, "cache fill"),
    LedgerRow("Registry.registryJson|commandCommitsToolEditBeforeApply", 1, "JSON publication"),
